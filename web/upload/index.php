...
//
$_CONFIG['users'] = array(array("user", "user", "user"), array("admin", "admin", "admin"));
...
//
$_CONFIG['upload_dirs'] = array("./upload/");
...
//
$_CONFIG['upload_allowed_extension'] = array("log");
...
class FileManager
{
	...
	*/
	...
	function uploadFile($location, $userfile)
	{
		...
		else if(is_array(EncodeExplorer::getConfig("upload_allowed_extension")) && count(EncodeExplorer::getConfig("upload_allowed_extension")) > 0 && !in_array($extension, EncodeExplorer::getConfig("upload_allowed_extension")))
		{
			$encodeExplorer->setErrorString("upload_type_not_allowed");
		}
...
<div id="top" style="text-align:center;">
	...
	<a href="<?php print $this->makeLink(false, false, null, null, null, ""); ?>"><img src="flupload.jpg" /></a>
<?php 
